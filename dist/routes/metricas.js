...
// src/routes/metricas.ts
var metricas_exports = {};
__export(metricas_exports, {
  metricasRoute: () => metricasRoute
});
module.exports = __toCommonJS(metricas_exports);
...
// src/routes/metricas.ts
async function metricasRoute(request, response) {
  if (!request.file) {
